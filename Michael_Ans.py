...
def generate_vals_from_ratio(array_size):
    blue_dot_favored_base = [(1, 1.1), (1, 1.2), (1, 1.3), (1, 1.5), (1,2)]
    ...
    blue_dot_favored = blue_dot_favored_base
    yellow_dot_favored = yellow_dot_favored_base
